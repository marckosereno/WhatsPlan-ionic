    ...
    ms.innerHTML = `
      ...
      <div style="position:relative;display:flex;align-items:center;justify-content:center;margin-bottom:2px;min-height:32px">
        ...
        <div style="position:absolute;right:0;display:flex;align-items:center;gap:4px;background:#eef0f2;border-radius:999px;height:34px;padding:0 4px;overflow:hidden;">
          <button id="wp-ms-fav-btn" style="width:36px;height:28px;border-radius:999px;border:none;background:#fff;display:flex;align-items:center;justify-content:center;cursor:pointer;-webkit-tap-highlight-color:transparent;color:#374151;padding:0;flex-shrink:0;">
          ...
          <button id="wp-ms-close-btn" style="width:36px;height:28px;border-radius:999px;border:none;background:#fff;display:flex;align-items:center;justify-content:center;cursor:pointer;-webkit-tap-highlight-color:transparent;color:#374151;padding:0;flex-shrink:0;">
