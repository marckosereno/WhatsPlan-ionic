      ...
      <div class="wp-pm-card" id="wp-pm-card">
        ...
        <div class="wp-pm-body" id="wp-pm-body">
          ...
          <div class="wp-pm-actions-row" id="wp-pm-actions-row">
            <button class="wp-pm-action-btn wp-pm-btn-green" id="wp-pm-btn-phone" style="display:none">
            ...
            <button class="wp-pm-action-btn wp-pm-btn-teal" id="wp-pm-btn-web" style="display:none">
            ...
            <button class="wp-pm-action-btn wp-pm-btn-orange" id="wp-pm-btn-maps">
  ...
  _injectStyles() {
    ...
    s.textContent = `
      ...
      .wp-pm-save-btn {
        ...
        box-shadow:0 2px 8px rgba(0,0,0,0.08),inset 0 -1px 0 rgba(0,0,0,0.04);
      ...
      /* Verde — Llamar */
      .wp-pm-btn-green {
        background:linear-gradient(170deg,rgba(240,253,244,0.95),rgba(220,252,231,0.88));
        border-color:rgba(134,239,172,0.5); color:#15803d;
      }
      .wp-pm-btn-green .wp-pm-action-icon { background:rgba(22,163,74,0.12); color:#16a34a; }

      /* Teal — Web */
      .wp-pm-btn-teal {
        background:linear-gradient(170deg,rgba(240,249,255,0.95),rgba(224,242,254,0.88));
        border-color:rgba(125,211,252,0.5); color:#0369a1;
      }
      .wp-pm-btn-teal .wp-pm-action-icon { background:rgba(8,145,178,0.12); color:#0891b2; }

      /* Naranja — Mapa */
      .wp-pm-btn-orange {
        background:linear-gradient(170deg,rgba(255,247,237,0.95),rgba(254,243,199,0.88));
        border-color:rgba(253,186,116,0.5); color:#c2410c;
      }
      .wp-pm-btn-orange .wp-pm-action-icon { background:rgba(234,88,12,0.12); color:#ea580c; }
      .wp-pm-action-icon {
