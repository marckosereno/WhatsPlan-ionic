...
export class LiquidGlassPanel {
  ...
  _renderPanel() {
    ...
    this.panel.innerHTML = `
      ...
      ${this._s('bgGradientAngle','BG Angle',0,360,1,p.bgGradientAngle)}
      <div style="height:1px;background:rgba(255,255,255,0.07);"></div>
      ...
      ${this._c('iconBgColor','Icon BG Color',p.iconBgColor)}
      ${this._s('iconBgOpacity','Icon BG Opacity',0,1,0.01,p.iconBgOpacity)}

      <div style="height:1px;background:rgba(255,255,255,0.07);margin:4px 0 2px;"></div>
      <div style="color:rgba(255,255,255,0.35);font-size:9px;font-weight:700;letter-spacing:1px;text-transform:uppercase;margin-bottom:4px;">SEARCH BAR</div>
      ${this._c('searchBg','BG Color',p.searchBg)}
      ${this._c('searchFont','Font Color',p.searchFont)}
      ${this._c('searchIcon','Icon Color',p.searchIcon)}
      ${this._c('searchIconBg','Icon BG',p.searchIconBg)}
      ${this._c('searchBadgeBg','Badge BG',p.searchBadgeBg)}
      ${this._c('searchBadgeFont','Badge Font',p.searchBadgeFont)}
      ${this._s('searchBlur','Blur Level',0,30,1,p.searchBlur)}
